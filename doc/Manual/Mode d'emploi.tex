...
\begin{figure} [h!]
	\centering
	\subfloat[Main menu]{\includegraphics[scale=0.15]{1_Menu.jpg}}
	\subfloat[World selector]{\includegraphics[scale=0.15]{2_WorldSelector.jpg}}
	\subfloat[Game]{\includegraphics[scale=0.15]{3_Game.jpg}}\\
	\subfloat[Winning screen]{\includegraphics[scale=0.15]{4_Win.jpg}}
	\subfloat[Losing screen]{\includegraphics[scale=0.15]{5_Lost.jpg}}
	\subfloat[Game over screen]{\includegraphics[scale=0.15]{6_GameOver.jpg}}\\
	\subfloat[Settings menu]{\includegraphics[scale=0.15]{7_Settings.jpg}}
	\subfloat[User settings menu]{\includegraphics[scale=0.15]{8_UserSettings.jpg}}
	\subfloat[Global settings menu]{\includegraphics[scale=0.15]{9_GlobalSettings.jpg}}
\end{figure}
